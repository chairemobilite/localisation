...
// FIXME: After updating Transition, consider using toXXhrYYminZZsec from DateTimeUtils for duration formatting.
// FIXME: Before switching, ensure it can format without seconds (e.g. "1 hr 2 min" instead of "1 hr 2 min 3 sec") to match the current UI.
